...
CREATE TABLE IF NOT EXISTS `elite-motion`.`sports_programs_contain_training_sessions` (
  ...
  PRIMARY KEY (`training_sessions_training_session_id`, `sports_programs_sports_program_id`),
  INDEX `fk_sports_programs_has_training_sessions_training_sessions1_idx` (`training_sessions_training_session_id` ASC) VISIBLE,
  UNIQUE INDEX `day_UNIQUE` (`day` ASC) INVISIBLE,
  INDEX `fk_sports_programs_contain_training_sessions_sports_program_idx` (`sports_programs_sports_program_id` ASC) VISIBLE,
  CONSTRAINT `fk_sports_programs_has_training_sessions_training_sessions1`
    FOREIGN KEY (`training_sessions_training_session_id`)
    REFERENCES `elite-motion`.`training_sessions` (`training_session_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sports_programs_contain_training_sessions_sports_programs1`
    FOREIGN KEY (`sports_programs_sports_program_id`)
    REFERENCES `elite-motion`.`sports_programs` (`sports_program_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
